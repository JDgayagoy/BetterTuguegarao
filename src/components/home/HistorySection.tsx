...
const TimelineEvent: React.FC<{
  ...
  return (
    <div className="relative pl-8 pb-8 group">
      {/* Timeline Line */}
      {!isLast && (
        <div className="absolute left-[12px] top-6 bottom-0 w-0.5 bg-gray-200 group-last:hidden" />
      )}

      {/* Timeline Dot */}
      <div className="absolute left-0.5 top-1.5 w-5 h-5 rounded-full border-4 border-white bg-primary-600 shadow-sm z-10" />
      ...
      <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-2">
          <span className="inline-block px-3 py-1 rounded-full bg-primary-50 text-primary-700 text-[10px] font-bold tracking-wider uppercase">
            {event.year}
          </span>
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-primary-900 rounded-3xl p-6 text-white shadow-2xl relative overflow-hidden group">
            ...
            <div className="bg-gray-50 rounded-3xl p-6 text-center border border-gray-100">
              <p className="italic text-gray-500 text-xs leading-relaxed mb-4">
                "Cagayan Valley's center of gravity—a city forged by missions,
                trade, and resilience."
              </p>
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-gray-100 text-[10px] font-black text-primary-700 uppercase tracking-widest shadow-sm">
                Established 1604
              </div>
            </div>
          </div>
